...
print('here')
print(rospack.get_path('YQ5'))

calib_l = load_yaml(rospack.get_path('YQ5')+'/script/pointgreyleft.yaml')
calib_r = load_yaml(rospack.get_path('YQ5')+'/script/pointgreyright.yaml')
