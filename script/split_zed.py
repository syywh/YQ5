...
calib_l = load_yaml('/home/dxq/workspace/ros_ws/laser_visual_ws/src/vill/script/left.yaml')
calib_r = load_yaml('/home/dxq/workspace/ros_ws/laser_visual_ws/src/vill/script/right.yaml')
...
raw = False
if raw:
  sub = Subscriber('/camera/image_raw', Image, cb)
