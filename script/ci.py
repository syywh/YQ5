...
calib_l = load_yaml('/home/xiaqing/Works/ros_codes/vill_ws/src/vill_ceres/script/pointgreyleft.yaml')
calib_r = load_yaml('/home/xiaqing/Works/ros_codes/vill_ws/src/vill_ceres/script/pointgreyright.yaml')
